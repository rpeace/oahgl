...
class PicksControllerTest < ActionController::TestCase
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post :create, pick: { hero_id: @pick.hero_id, match_id: @pick.match_id, order: @pick.order, team_id: @pick.team_id }
    end
  ...
  test "should update pick" do
    patch :update, id: @pick, pick: { hero_id: @pick.hero_id, match_id: @pick.match_id, order: @pick.order, team_id: @pick.team_id }
    assert_redirected_to pick_path(assigns(:pick))
  end
